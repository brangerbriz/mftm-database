...
data = open_csv_writers('/media/bbpwn2/emerge_drive/mftm-database/data/csv')

blockchain = Blockchain(sys.argv[1])
last_block_height = -1
for block, blk_file in blockchain.get_unordered_blocks(start_blockfile_basename='blk00980.dat'):
    ...
    #     print('[!] caught AssertionError in block #{}'.format(block.hash), file=sys.stderr)
