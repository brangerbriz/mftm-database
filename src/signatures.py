...
files['webp'] = re.compile('^52494646', re.IGNORECASE)
files['exr']  = re.compile('^762f3101', re.IGNORECASE)

# video
files['mpeg'] = re.compile('^000001b', re.IGNORECASE)
files['mp4']  = re.compile('^.{8}66747970', re.IGNORECASE)
...
files['avi']  = re.compile('^52494646', re.IGNORECASE)
...
files['m4a']  = re.compile('^.{8}(667479704d3441|667479704d344120)', re.IGNORECASE)
...
# compression
files['zip']    = re.compile('^(05b4304|504b0506|504b0708|05b41020|504b0304)', re.IGNORECASE)
# files['gzip']   = re.compile('^1f8b', re.IGNORECASE)
...
files['tar']    = re.compile('^.{514}7573746172', re.IGNORECASE)
...
# misc
files['pdf']    = re.compile('^(524e4301|524e4302)', re.IGNORECASE)
...
files['crx']    = re.compile('^(524e4301|524e4302)', re.IGNORECASE)
...
# files['exe']     = re.compile('^4d5a', re.IGNORECASE)
